...
int main()
{
    // provie points in form of pt to fortune struct
    ...
    fortune ft(pts);
    ft.solve();
    for(int i=0 ; i<ft.edges.size(); i++)
    {
        cout << pts[ft.edges[i].first].x << ", " << pts[ft.edges[i].second].x;
        if(i!=ft.edges.size()-1)
        {
            cout << ", ";
        }
    }
    ...
    for(int i=0 ; i<ft.edges.size(); i++)
    {
        cout << pts[ft.edges[i].first].y << ", " << pts[ft.edges[i].second].y;
        if(i!=ft.edges.size()-1)
        {
            cout << ", ";
        }
